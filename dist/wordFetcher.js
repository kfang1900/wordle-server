...
function getCurState() {
    ...
    console.log("Type of data.usedWords:", typeof data.usedWords);
...
function fetchNewWord() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`Give me a random 5-letter English word for a Wordle game. The word should not be ${usedWordsString} and not be plural or a proper noun. Just return the word, in all caps, and nothing else.`);
        try {
